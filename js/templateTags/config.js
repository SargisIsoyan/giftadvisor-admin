export default function (nga, admin) {
    ...
    var tags = admin.getEntity('template_tags');
    tags.listView()
        .title('Template Tags')
        .fields([
        ...
        .listActions([
            '<ma-filtered-list-button entity-name="templates" filter="{ tags: [entry.values._id] }" size="xs" label="Related Templates"></ma-filtered-list-button>',
            'edit',
            'delete'
        ])
